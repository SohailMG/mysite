...
function Sidebar() {
    ...
    return (
      <div className="relative w-20 md:w-48 h-screen bg-[#10245A] shadow-lg drop-shadow-xl transition duration-2">
        {/* Top avatar */}
        <CgMenuGridR className="text-4xl m-2 text-orange-500 cursor-pointer  absolute top-0 right-0" />
        {/* Navigation buttons */}
        <div className="">
          <nav className="mt-20">
            <a
